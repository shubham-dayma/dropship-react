...
(()=>{
    var t = {
        ...
        418: t=>{
            ...
            t.exports = function() {
                ...
                for (var a, l, u = o(t), c = 1; c < arguments.length; c++) {
        ...
        408: (t,e,n)=>{
            ...
            function S(t, e, n) {
                ...
                if (null != e)
                    ...
                    e)
                        w.call(e, r) && !C.hasOwnProperty(r) && (i[r] = e[r]);
            ...
            function x(t, e, n, r, a) {
                ...
                if (u)
                    ...
                    t = "" === r ? "." + E(u, 0) : r,
                    Array.isArray(a) ? (n = "",
                    null != t && (n = t.replace(_, "$&/") + "/"),
                    x(a, e, n, "", (function(t) {
                        return t
                    }
                    ))) : null != a && (j(a) && (a = function(t, e) {
                        return {
                            $$typeof: o,
                            type: t.type,
                            key: e,
                    ...
                    }(a, n + (!a.key || u && u.key === a.key ? "" : ("" + a.key).replace(_, "$&/") + "/") + t)),
                    e.push(a)),
                    1;
                if (u = 0,
                r = "" === r ? "." : r + ":",
                ...
                else if ("function" == typeof (s = function(t) {
                    return null === t || "object" != typeof t ? null : "function" == typeof (t = p && t[p] || t["@@iterator"]) ? t : null
                }(t)))
                    for (t = s.call(t),
                    c = 0; !(l = t.next()).done; )
                        u += x(l = l.value, e, n, s = r + E(l, c++), a);
                else if ("object" === l)
                    throw e = "" + t,
                    Error(d(31, "[object Object]" === e ? "object with keys {" + Object.keys(t).join(", ") + "}" : e));
                return u
            }
            function P(t, e, n) {
                if (null == t)
            ...
            e.cloneElement = function(t, e, n) {
                ...
                if (null != e) {
                    ...
                    for (s in e)
                        w.call(e, s) && !C.hasOwnProperty(s) && (i[s] = void 0 === e[s] && void 0 !== c ? c[s] : e[s])
                }
        ...
        379: (t,e,n)=>{
            ...
            t.exports = function(t, e) {
                (e = e || {}).singleton || "boolean" == typeof e.singleton || (e.singleton = (void 0 === r && (r = Boolean(window && document && document.all && !window.atob)),
                r));
                var n = l(t = t || [], e);
                return function(t) {
                    if (t = t || [],
                    "[object Array]" === Object.prototype.toString.call(t)) {
                        ...
                        for (var u = l(t, e), c = 0; c < n.length; c++) {
                            var s = a(n[c]);
                            0 === i[s].references && (i[s].updater(),
                            i.splice(s, 1))
                        }
                        n = u
                    }
    ...
    (()=>{
        ...
        var u = {
          ...
          , c = t.createContext && t.createContext(u)
          , s = function() {
        ...
        function f(e) {
            return e && e.map((function(e, n) {
                return t.createElement(e.tag, s({
                    key: n
                }, e.attr), f(e.child))
            }
            ))
        ...
        function d(e) {
            var n = function(n) {
                var r, o = e.attr, i = e.size, a = e.title, l = function(t, e) {
                    var n = {};
                    for (var r in t)
                    ...
                    return n
                }(e, ["attr", "size", "title"]), u = i || n.size || "1em";
                return n.className && (r = n.className),
                e.className && (r = (r ? r + " " : "") + e.className),
                t.createElement("svg", s({
                    stroke: "currentColor",
                    fill: "currentColor",
                    strokeWidth: "0"
                }, n.attr, o, l, {
                ...
                }), a && t.createElement("title", null, a), e.children)
            };
            return void 0 !== c ? t.createElement(c.Consumer, null, (function(t) {
                return n(t)
            }
            )) : n(u)
        }
        ...
        function w(t, e) {
            return !e || "object" !== v(e) && "function" != typeof e ? C(t) : e
        }
        function C(t) {
            if (void 0 === t)
        ...
        var j = function(e) {
            ...
            function l(t) {
                ...
                (n = a.call(this, t)).triggerRotate = n.triggerRotate.bind(C(n)),
                n.state = {
                    id: null !== (e = n.props.id) && void 0 !== e ? e : "LoadingCog-".concat(parseInt(1e3 * Math.random())),
                    rotateInterval: void 0,
                    rot: 0
                },
                n.props.rotating && n.triggerRotate(),
                n
            }
            return n = l,
            (r = [{
                ...
                value: function() {
                    ...
                    this.state.rotateInterval && (window.clearInterval(this.state.rotateInterval),
                    t && this.setState({
                        rotateInterval: void 0
                    }))
                }
                ...
                value: function() {
                    var t = this;
                    this.state.rotateInterval && this.endRotate(!1);
                ...
                value: function(t) {
                    !t.rotating && this.props.rotating ? this.triggerRotate() : t.rotating && !this.props.rotating && this.endRotate()
                }
            }, {
                key: "render",
                value: function() {
                    var e, n = this.props.style ? function(t) {
                    ...
                    return n.transform = "rotate(".concat(this.state.rot, "deg)"),
                    t.createElement(t.Fragment, null, t.createElement("div", {
                        style: n,
                        className: "loadingCog",
                        id: this.state.id
                    }, t.createElement(y, {
                        size: null !== (e = this.props.size) && void 0 !== e ? e : 30
                    })))
                }
            }]) && m(n.prototype, r),
            l
        ...
        function k(t, e) {
            return !e || "object" !== E(e) && "function" != typeof e ? R(t) : e
        }
        function R(t) {
            if (void 0 === t)
                throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
        ...
        var I = function(e) {
            ...
            function l(t) {
                ...
                (i = a.call(this, t)).handleTextChange = i.handleTextChange.bind(R(i));
                var u = null !== (e = i.props.id) && void 0 !== e ? e : "floating-label".concat(parseInt(1e3 * Math.random()));
                return i.state = {
                    isActive: !!i.props.initialValue,
                    text: null !== (n = i.props.initialValue) && void 0 !== n ? n : "",
                    id: u,
                    labelId: null !== (r = i.props.labelId) && void 0 !== r ? r : "".concat(u, "-label"),
                    inputId: null !== (o = i.props.inputId) && void 0 !== o ? o : "".concat(u, "-input"),
            ...
            (r = [{
                key: "componentDidUpdate",
                value: function(t) {
                    this.props.initialValue !== t.initialValue && this.setState({
                ...
                value: function(t) {
                    ...
                    if (this.setState({
                        isActive: "" !== t.target.value,
                        text: t.target.value
                    }),
                    this.props.onChange)
                        if (this.props.onChangeDelay)
                            if (this.state.queuedChangeTimeout && clearTimeout(this.state.queuedChangeTimeout),
                            n)
        ...
        I.propTypes = {
            ...
            onChange: o().func,
            onBlur: o().func,
            onChangeDelay: o().number,
            label: o().string,
            style: o().object,
            labelStyle: o().object,
            inputStyle: o().object,
            loadingCog: o().bool,
            loadingCogSpinning: o().bool,
            loadingCogSize: o().number,
            loadingCogStyle: o().object,
